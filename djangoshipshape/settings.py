"""
Django settings for djangoshipshape project.
...
ROOT_URLCONF = 'djangoshipshape.urls'
...
WSGI_APPLICATION = 'djangoshipshape.wsgi.application'
...
# Map Django's message levels onto Bootstrap 5 alert classes.
